        ...
        switch (identifier) {
            ...
            case "nether":
                ...
                if (Config.Setting.NETHER_STORE_TIME.getBoolean()) {
                    return MiscUtils.getDurationBreakdown((Config.Setting.NETHER_RESETS_INTERVAL.getInt() * 3600000L + plugin.getData().getLong("nether.millis")) - System.currentTimeMillis());
                } else {
                    return MiscUtils.getDurationBreakdown((Config.Setting.NETHER_RESETS_INTERVAL.getInt() * 3600000L + plugin.getData().getLong("nether.papi")) - System.currentTimeMillis());
                }
            case "end":
                ...
                if (Config.Setting.END_STORE_TIME.getBoolean()) {
                    return MiscUtils.getDurationBreakdown((Config.Setting.END_RESETS_INTERVAL.getInt() * 3600000L + plugin.getData().getLong("end.millis")) - System.currentTimeMillis());
                } else {
                    return MiscUtils.getDurationBreakdown((Config.Setting.END_RESETS_INTERVAL.getInt() * 3600000L + plugin.getData().getLong("end.papi")) - System.currentTimeMillis());
                }
        }
        return null;
    }
