...
public class Lang {
    ...
    public void addDefaults() {
        ...
        Lang.get().addDefault("teleporting_player", "&aTeleporting %player% to %world%.");
        ...
        Lang.get().addDefault("fixed_mistakes", "&c&lEncountered Errors in your Configuration File, Some values have been Reset or Modified. &6&l%mistakes%");
    }
}
