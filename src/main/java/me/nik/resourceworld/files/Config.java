...
public class Config {
    ...
    public enum Setting {
        ...
        WORLD_RESET_ON_STARTUP("world.reset_on_startup", false, "Should we automatically reset the resource world on server startup?", "This overrides the options below"),
        ...
        NETHER_RESET_ON_STARTUP("nether.reset_on_startup", false, "Should we automatically reset the resource world on server startup?", "This overrides the options below"),
        ...
        END_RESET_ON_STARTUP("end.reset_on_startup", false, "Should we automatically reset the resource world on server startup?", "This overrides the options below"),
