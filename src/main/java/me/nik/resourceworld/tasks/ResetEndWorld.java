...
public class ResetEndWorld extends BukkitRunnable {
    ...
    public void run() {
        ...
        if (manager.configBoolean("end_world.settings.automated_resets.store_time_on_shutdown")) {
        ...
        World world = Bukkit.getWorld(manager.configString("end_world.settings.world_name"));
